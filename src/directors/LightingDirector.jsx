  ...
  useFrame((state, delta) => {
    ...
    if (p >= 0.15 && p <= 0.55) {
        ...
        if (p < 0.70) {
           ...
           intensityFactor = (1 - (p - 0.85) / 0.15); 
        }
        
        targetColor = defaultColor.clone().lerp(windColor, intensityFactor);
        targetIntensity = THREE.MathUtils.lerp(3.0, 2.0, intensityFactor); // Still bright
        targetAmbient = THREE.MathUtils.lerp(1.5, 1.8, intensityFactor);
    }
